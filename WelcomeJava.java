...
class WelcomeJava {
  public static void main(String[] args) {
    ...
    *
    *.out atributo estático de la clase System.
    *Representa la salida estándar (normalmente la consola).
    *El método println() se usa para mostrar texto en la consola
    *y luego pasar a la siguiente línea.
    */
